...
const JournalScreen = ({ setSelectedScreen, }) => {
  ...
  const handleSaveTodayReflection = async () => {
    const newReflectionId = reflactions.length > 0 ? Math.max(...entertainments.map(e => e.id)) + 1 : 1;
    const newReflection = {
      id: newReflectionId,
      glassesOfWater,
      hoursSleep,
    ...
    try {
      ...
      console.log('Reflection added to the list');
            ...
            <View style={{
              ...
              {Array.from({ length: 4 }, (_, i) => {
                ...
                <TouchableOpacity
                  key={index}
                  style={{
                    backgroundColor: index === arr.length - 1 ? '#005B41' : '#D2C780', // today (last item) highlighted
            ...
            {todayReflection ? (
              <>
                  ...
                  {['Hydrated', 'Dry', 'Oily', 'Sensitive', 'Normal'].map((skinFeel, index) => (
                    <View
                      key={index} style={{
                        ...
                        backgroundColor: todayReflection.selectedSkinFeel === skinFeel ? '#005B41' : '#D2C780',
                ...
                <Text
                  ...
                  {todayReflection.changesOfConcerns}
                </Text>
                  ...
                  {['Soft', 'Frizzy', 'Oily', 'Dry', 'Normal'].map((hairFeel, index) => (
                    <View
                      key={index} style={{
                        borderRadius: dimensions.width * 0.5,
                        paddingHorizontal: dimensions.width * 0.03,
                        backgroundColor: todayReflection.selectedHairFeel === hairFeel ? '#005B41' : '#D2C780',
                        marginRight: dimensions.width * 0.03,
                        marginVertical: dimensions.height * 0.005,
                      }}>
                      <Text
                ...
                <View style={{
                  ...
                  <Text
                    ...
                    {todayReflection.glassesOfWater}
                  </Text>
                  <Text
                    style={{
                      fontFamily: fontPoppinsRegular,
                ...
                <TouchableOpacity
                  onPress={() => setIsEditindTodayRelfection(true)}
                  style={{
                    backgroundColor: '#005B41',
                    borderRadius: dimensions.width * 0.5,
                ...
                <TouchableOpacity
                  onPress={() => handleDeleteTodayReflaction(todayReflection.id)}
                  style={{
                    borderRadius: dimensions.width * 0.5,
                    alignSelf: 'center',
                    width: dimensions.width * 0.9,
